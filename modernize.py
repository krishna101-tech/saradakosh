...
.level1 { color: #d35400; font-weight: 700; font-size: 1.25rem; margin-top: 35px; margin-bottom: 12px; border-bottom: 1px solid #f2e3d5; padding-bottom: 5px; }
.level2 { color: #2980b9; font-weight: 600; font-size: 1.05rem; margin-left: 20px; margin-top: 15px; margin-bottom: 8px; border-left: 3px solid #3498db; padding-left: 12px; }
...
for file in os.listdir(reports_dir):
    if file.endswith(".html"):
        ...
        # Replace whatever is between <style> and </style> with modern_style
        # Make sure to use re.DOTALL so it matches across newlines
        new_content = re.sub(r'<style>.*?</style>', modern_style, content, flags=re.DOTALL)
